...
\begin{minipage}[t]{0.5\textwidth}%
  ...
  {\titlefont\color{titlecolor}US citizen, Science communicator, Mechanical engineer}%
\end{minipage}\hfill%
\begin{minipage}[t]{0.3\textwidth}\flushright%
  \vspace*{1ex}%
  {\addressfont\color{addresscolor}409 E. Kingsley St Apt 2.\\Ann Arbor, MI, 48104\\marchdf@umich.edu\\(734)747-0156}%
\end{minipage}\\[2em]%
%
%
%
...
\begin{minipage}[t]{0.82\textwidth}%
  ...
  \item[\normalfont Thesis:]\textit{Numerical Simulations of waves, shocks and blasts interacting with interfaces in highly compressible multiphase flows}%
  \item[\normalfont Advisor:]E. Johnsen, Assistant Professor of Mechanical Engineering%
  %% \item[\normalfont Selected coursework:] Compressible Flow, Advanced Fluid Mechanics, Turbulent Flow, Advanced Heat Transfer, Space Physics, High Energy Density Physics, Data Science Specialization (John Hopkins University through Coursera)%
  %% \item[\normalfont GPA:]4.00%
  \end{description}%
\end{minipage}\hfill%
...
%
%
%% {\sectionfont\color{sectiontitlecolor}{References}\hspace*{0.5cm}\raisedrule[0.5ex]{1pt}}\\[0.5ex]%
%% Eric Johnsen, Assistant Professor of Mechanical Engineering, University of Michigan\\%
%% 734-647-1450, ejohnsen@umich.edu\\[2ex]%
%% Paul Drake, Henry S. Carhart Collegiate Professor of Space Sciences, University of Michigan\\%
%% 734-763-4072, rpdrake@umich.edu\\[2ex]%
%% Rob Cavallo, Scientist, Lawrence Livermore National Laboratory\\%
%% 925-422-3277, rcavallo@llnl.gov\\[3ex]%
%
%
%
%
{\sectionfont\color{sectiontitlecolor}{Science Communication Experience}\hspace*{0.5cm}\raisedrule[0.5ex]{1pt}}\\[0.5ex]%
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{ArtsEngine Microgrant, University of Michigan}\\%
  Children's book author, collaborators: Brandon Patterson, Erika Lazar\\%
  Awarded grant to write a children's book about my research on bubbles%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  Spring 2016%
\end{minipage}\\[2ex]%
...
\begin{minipage}[t]{0.82\textwidth}%
  ...
  \hphantom{-} Communicate graduate student research to lay audiences through web articles\\[1ex]%
  - Graduate Seminar Chair\\%
  \hphantom{-} Organize monthly seminars to coach graduate student presentation skills%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2013-2016%
\end{minipage}\\[3ex]%
...
\begin{minipage}[t]{0.82\textwidth}%
  ...
  Identify and plan activities to promote community among engineering students%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2014-2015%
\end{minipage}\\[3ex]%
...
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{Towner Prize for Distinguished Academic Achievement}\\%
  University of Michigan\\%
  Presented to the outstanding graduate student, considering student’s active participation in research, leadership and academic performance (\$1,000)%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2016%
\end{minipage}\\[2ex]%
...
\begin{minipage}[t]{0.82\textwidth}%
  ...
  University of Michigan\\%
  Supports outstanding doctoral students for a year%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2015%
\end{minipage}\\[2ex]%
...
M. T. Henry de Frahan, L. Khieu, and E. Johnsen, \textbf{High-order Discontinuous Galerkin Methods Applied to Multiphase Flows}, \textit{$23^{\text{d}}$ AIAA Computational Fluid Dynamics Conference}, Jun. 2013, Dallas, Tx\\[2ex]%
