...
\title{\small US citizen, Applied Mathematics/Mechanical engineer}              
...
\begin{minipage}[t]{0.82\textwidth}%
  ...
  Thesis: \textit{Numerical Simulations of waves, shocks and blasts interacting with interfaces in highly compressible multiphase flows}\\%
...
\end{minipage}\\[2ex]%
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{Univeristy of Michigan, Ann Arbor, MI}\\%
  Graduate Student Instructor for ME/AERO 523: Computational Fluid Dynamics%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  Fall 2013%
\end{minipage}\\[2ex]%
...
%
%
{\sectionfont\color{sectiontitlecolor}{Mentorship Experience}\hspace*{0.5cm}\raisedrule[0.5ex]{1pt}}\\[0.5ex]%
\begin{minipage}[t]{0.82\textwidth}%
...
M. T. Henry de Frahan, J. L. Belof, R. M. Cavallo, O. Ignatova, E. Johnsen, B. A. Remington, V. Raevsky, {\link[\textbf{Beryllium strength under extreme dynamic loading conditions}]{http://meeting.aps.org/Meeting/DPP12/Event/176052}}, \textit{APS $54^{\text{th}}$ Meeting of the Division of Plasma Physics}, Oct. 2012, Providence, RI\\[3ex]%
