...
\begin{minipage}[t]{0.3\textwidth}\flushright%
  \vspace*{1ex}%
  {\addressfont\color{addresscolor}1619 S Van Gordon Ct\\Lakewood, CO, 80228\\marchdf@gmail.com\\(734)747-0156}%
\end{minipage}\\[2em]%
%
%
%
...
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{Julia Ream, National Renewable Energy Laboratory}\\%
  Mentored Ph.D. graduate student for a project on turbulent supercritical CO2 jet simulations%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2019%
\end{minipage}\\[2ex]%
...
\href{http://arxiv.org/abs/1901.05557}{M. T. Henry de Frahan, S. Yellapantula, R. King, M. Day, and R. Grout, \textbf{Deep learning for presumed probability density function models}, \textit{arXiv:1901.05557}, 2019}\\[2ex]%
