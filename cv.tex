...
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{Senior Developer Technology Engineer, NVIDIA}\vspace*{0.5ex}%
  \begin{itemize}[itemsep=0.5ex]
  \item[-] Accelerating high performance computing codes on graphics processing units%
  \end{itemize}
\end{minipage}\hfill%
...
\end{minipage}\\[3ex]%
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{Computational Scientist, National Renewable Energy Laboratory}\vspace*{0.5ex}%
  \begin{itemize}[itemsep=0.5ex]
  \item[-] \textbf{Principal Investigator}, Scalable Parallel Discrete Events Simulations, \$550k\\%
    Developed a GPU solver for parallel discrete events simulations, 2023-2025%
  \item[-] \textbf{Principal Investigator}, Adaptive Mesh and Algorithm Refinement, \$500k\\%
    Developed two-way coupled continuum-atomistic modeling framework, 2021-2023%
  \item[-] \textbf{Acting Group Manager}, High Performance Algorithms and Complex Fluids\\%
    Group lead for a team of 15+ scientists, 2020-2021%
  \item[-] \textbf{Principal developer} of Exascale Computing Project software (Pele, ExaWind)\\%
    Wrote GPU performance portability for reacting flows and wind turbine physics
  \item[-] \textbf{Lead scientist} of AI/ML investigations\\%
    Developed AI/ML reduced order models for physics applications using GPUs
  \item[-] \textbf{Mentor} for scientists and students\\%
...
\end{minipage}\\[3ex]%
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{Post-doctoral Researcher, National Renewable Energy Laboratory}\vspace*{0.5ex}%
  \begin{itemize}[itemsep=0.5ex]
  \item[-] Next-generation simulations of wind farms and reacting flow processes%
  \item[-] Performance analysis and improvement on GPUs for exascale software%
  \item[-] Deep learning and deep reinforcement learning models for physics applications%
  \end{itemize}
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2016-2019%
...
\href{https://doi.org/10.5194/wes-11-3719-2026}{L. Cheung, P. Mohan, M. T. {Henry de Frahan}, G. Yalla,  A. Hsieh, K. Brown, N. deVelder, S. Kaufman-Martin,  M. Day, M. A. Sprague, \textbf{SANDWake3D: a 3D parabolic RANS solver for atmospheric surface layers and turbine wakes}, \textit{Wind Energy Science}, vol. 11, 9, 2026}\\[2ex]
\href{https://doi.org/10.5194/wes-2024-155}{L. Cheung, G. Yalla, P. Mohan, A. Hsieh, K. Brown, N. deVelder, D. Houck, M. T. {Henry de Frahan}, M. Day, M. A. Sprague, \textbf{Modeling the effects of active wake mixing on wake behavior through large-scale coherent structures}, \textit{Wind Energy Science}, vol. 10, 7, 2025}\\[2ex]
\href{https://doi.org/10.1109/MCSE.2025.3556567}{S. Yellapantula, N. T. Wimer, M. T. {Henry de Frahan}, Sreejith N. A., M. J. Martin, B. A. Perry, H. Sitaraman, M. Rahimi,  M. Day, \textbf{Accelerating Innovative Energy Solutions Using Combustion Simulations}, \textit{Computing in Science and Engineering}, vol. 27, 1, 2025}\\[2ex]
\href{https://doi.org/10.1109/MCSE.2025.3555589}{K. P. Griffin, H. Egan, M. T. {Henry de Frahan}, J. Mueller, D. Vaidhynatha, D. Wald, R. Chintala, O. A. Doronina, H. Sitaraman, E. Young, R. King, J. Sanyal, M. Day, \textbf{Adaptive Computing for Scale-up Problems}, \textit{Computing in Science and Engineering}, vol. 27, 1, 2025}\\[2ex]
\href{https://doi.org/10.1002/we.70010}{M. B. Kuhn, M. T. {Henry de Frahan}, P. Mohan, G. Deskos, M. Churchfield, L. Cheung, A. Sharma, A. Almgren, S. Ananthan, M. J. Brazell, L. A. {Martinez-Tossas}, R. Thedin, J. Rood, P. Sakievich, G. Vijayakumar, W. Zhang, M. A. Sprague, \textbf{AMR-Wind: A performance-portable, high-fidelity flow solver for wind farm simulations}, \textit{Wind Energy}, vol. 28, 5, 2025}\\[2ex]
...
\href{https://doi.org/10.1145/3581784.3607065}{N. Malaya, \dots, M. T. Henry de Frahan, et al., \textbf{Experiences Readying Applications for Exascale}, \textit{SC23 Proc. Int. Conf. HPC}, 2023}\\[2ex]%
...
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{R\&D 100 Award Winner}, for Pele Suite of Exascale Reacting Flow Codes, NREL%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2026%
\end{minipage}\\[1ex]%
...
\end{minipage}\\[1ex]%
\begin{minipage}[t]{0.82\textwidth}%
  \href{https://bssw.io/blog_posts/introducing-the-2018-bssw-fellows}{\textbf{Better Scientific Software Fellowship (honorable mention)}}, Dep. of Energy%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2018%
\end{minipage}\\[1ex]%
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{AIAA CFD Best Student Paper Award ($3^{\text{d}}$ place)}, AIAA%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2015%
\end{minipage}\\[1ex]%
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{Rackham Predoctoral Fellowship}, University of Michigan%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2015%
\end{minipage}\\[1ex]%
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{Rackham Centennial Fellowship}, University of Michigan%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2013%
\end{minipage}\\[1ex]%
...
% \end{minipage}\\[2ex]%
\begin{minipage}[t]{0.82\textwidth}%
  \textbf{High Distinction}, M.S. in Applied Mathematics at the Univ. Catholique de Louvain%
\end{minipage}\hfill%
\begin{minipage}[t]{0.15\textwidth}\flushright%
  2011%
\end{minipage}\\[3ex]%
...
C/C++, Python, \textsc{GPU} (\textsc{CUDA}, \textsc{SYCL}, \textsc{ROCM}, Kokkos, AMReX), \textsc{MPI}, OpenMP, OpenACC, Git, Pytorch, Tensorflow, OpenGym\\[2ex]%
