...
%
%
{\sectionfont\color{sectiontitlecolor}{Selected Journal Articles}\hspace*{0.5cm}\raisedrule[0.5ex]{1pt}}\\[0.5ex]%
\href{https://doi.org/10.1002/we.70010}{M. B. Kuhn, et al, \textbf{AMR-Wind: A performance-portable, high-fidelity flow solver for wind farm simulations}, \textit{Wind Energy}, 2025}\\[0.5ex]
\href{https://doi.org/10.1016/j.combustflame.2024.113740}{M. Hassanaly, et al, \textbf{Symbolic construction of the chemical Jacobian of quasi-steady state (QSS) chemistries for Exascale computing platforms}, \textit{Comb. and Flame}, vol. 270, 113740, 2024}\\[0.5ex]
\href{https://doi.org/10.1016/j.jcp.2024.112879}{I. Barrio Sanchez, et al, \textbf{A New Re-redistribution Scheme for Weighted State Redistribution with Adaptive Mesh Refinement}, \textit{J. Comp. Phys.}, vol. 504, 1, 112879, 2024}\\[0.5ex]
\href{https://doi.org/10.1137/1.9781611977967.2}{M. T. Henry de Frahan, et al, \textbf{The Pele Simulation Suite for Reacting Flows at Exascale}, \textit{Proc. 2024 SIAM Conf. Parallel Proc. Sc. Comput.}, 15-25, 2024}\\[0.5ex]
\href{https://doi.org/10.1002/we.2886}{A. Sharma, et al, \textbf{ExaWind: Open-source CFD for hybrid-RANS/LES geometry-resolved wind turbine simulations in atmospheric flows}, \textit{Wind Energy}, vol 27, 3, 225-257, 2024}\\[0.5ex]
\href{https://doi.org/10.1103/PhysRevFluids.8.110511}{N. Wimer, et al, \textbf{Visualizations of a Methane/Diesel RCCI Engine using PeleC and PeleLMeX}, \textit{Phys. Rev. Fluids}, 8, 110511, 2023}\\[0.5ex]
\href{https://doi.org/10.21105/joss.05450}{L. Esclapez, et al, \textbf{PeleLMeX: an AMR Low Mach Number Reactive Flow Simulation Code without level sub-cycling}, \textit{J. Open Source Software}, 8, 90, 5450, 2023}\\[0.5ex]
\href{https://doi.org/10.1177/1468087423118400}{N. T Wimer, et al, \textbf{Deep reinforcement learning to discover multi-fuel injection strategies for compression ignition engines}, \textit{Int. J. Eng. Res.}, vol 24, 9, 2023}\\[0.5ex]
\href{https://doi.org/10.1103/PhysRevFluids.6.110504}{A. Giuliani, et al, \textbf{A weighted state redistribution algorithm for embedded boundary grids}, \textit{J. Comp. Phys.}, 111305, 2022}\\[0.5ex]
...
\href{http://dx.doi.org/10.1063/1.4922336}{M. T. Henry de Frahan, et al, \textbf{Experimental and Numerical Investigations of Beryllium Strength Models Using the Rayleigh-Taylor Instability}, \textit{featured article in J. Appl. Phys.}, 117(22):225901, 2015}\\[0.5ex]%
\href{http://dx.doi.org/10.1016/j.jcp.2014.09.030}{M. T. Henry de Frahan, et al, \textbf{A new limiting procedure for discontinuous Galerkin methods applied to compressible multiphase flows with shocks and interfaces}, \textit{J. Comput. Phys.}, 280(0):489 -- 509, 2015}\\[0.5ex]%
\href{http://dx.doi.org/10.1007/s00193-014-0539-y}{M. T. Henry de Frahan, et al, \textbf{Numerical simulations of a shock interacting with successive interfaces using the Discontinuous Galerkin method: the multilayered Richtmyer-Meshkov and Rayleigh-Taylor instabilities}, \textit{Shock Waves}, 25(4):329--345, 2015}\\[0.5ex]%
\href{http://dx.doi.org/10.1063/1.4872223}{C. A. Di Stefano, et al, \textbf{Observation and modeling of mixing-layer development in high-energy-density, blast-wave-driven shear flow}, \textit{Phys. Plasmas}, 21(5):056306, 2014}\\[2ex]%
